...
class Fly extends Component {
  componentDidMount() {
    var czml = [
      ...
      },
      {
        ...
        position: {
          ...
          cartographicDegrees: [
            0, -122.93797, 39.50935, 1776, 30, -122.93822, 39.50918, 1773, 90, -122.9385, 39.50883,
            1772, 140, -122.93855, 39.50842, 1770, 200, -122.93868, 39.50792, 1770, 250, -122.93877,
            39.50792, 1770
          ]
        }
      }
    ...
    var viewer = new Cesium.Viewer('stage', {
