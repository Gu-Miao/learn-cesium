...
function Buffer() {
  ...
  const viewerRef = useCesium(viewer => {
    ...
    viewer.screenSpaceEventHandler.setInputAction(() => void 0, ScreenSpaceEventType.MOUSE_MOVE)

    viewer.screenSpaceEventHandler.setInputAction(() => void 0, ScreenSpaceEventType.RIGHT_CLICK)
  })
